...
def upload_location(instance, filename, **kwargs):
    file_path = 'survey/{author_id}/{title}/{title}-{filename}'.format(
...
class Survey(models.Model):
    ...
    slug = models.SlugField(blank=True, unique=False)   #temparery slug feald make as uneq false
...
pre_save.connect(pre_save_blog_post_receiever, sender=Survey)
